...
/* Sample Results:
Line 14: Enter the number of volunteers: 3

Line 21: Enter the volunteer's name and the number of boxes sold: Name1 4 

Line 21: Enter the volunteer's name and the number of boxes sold: Name2 5

Line 21: Enter the volunteer's name and the number of boxes sold: Name3 6

Line 27: The total number of boxes sold: 15
Line 28: Enter the cost of one box: 2

Line 31: The total money made by selling cookies: $30.00
Line 33: The average number of boxes sold by each volunteer: 5
*/
